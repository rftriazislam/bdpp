                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn  text-white btn-primary"
                                                href="{{ route('admin.userRole', [$slider->id, 'superAdmin']) }}"> Super
                                                Admin
                                            </a>
                                            <a class="btn  text-white btn-success"
                                                href="{{ route('admin.userRole', [$slider->id, 'admin']) }}"> Admin </a>
                                            <a class="btn  text-white btn-secondary"
                                                href="{{ route('admin.userRole', [$slider->id, 'user']) }}"> User </a>
                                        </td>
