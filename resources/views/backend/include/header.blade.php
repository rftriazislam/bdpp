    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="/">
                ...
                <span class="logo-name">D</span>
            </a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown active">
                <a href="{{ route('admin.admin') }}" class="nav-link"><i
                        data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            

            <li class="dropdown ">
                <a href="{{ route('admin.userList') }}" class="nav-link"><i
                        data-feather="monitor"></i><span>Users</span></a>
            </li>
 
         
            <li class="dropdown ">
                <a href="{{ route('admin.edit.setting') }}" class="nav-link"><i
                        data-feather="monitor"></i><span>Settings</span></a>
            </li>
